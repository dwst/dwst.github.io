...
var _parsee = __webpack_require__(3);
...
var instructionArgChars = smallChars.concat(digitChars);
...
function readUnicodeSequence(parsee) {
  ...
  var charValue = String.fromCodePoint(charCode);
  return charValue;
}
...
var _binary = __webpack_require__(47);

var _binary2 = _interopRequireDefault(_binary);

var _bins = __webpack_require__(48);

var _bins2 = _interopRequireDefault(_bins);

var _clear = __webpack_require__(49);
...
var _disconnect = __webpack_require__(52);

var _disconnect2 = _interopRequireDefault(_disconnect);

var _forget = __webpack_require__(53);
...
var _interval = __webpack_require__(55);

var _interval2 = _interopRequireDefault(_interval);

var _loadbin = __webpack_require__(56);

var _loadbin2 = _interopRequireDefault(_loadbin);

var _loadtext = __webpack_require__(57);

var _loadtext2 = _interopRequireDefault(_loadtext);

var _pwa = __webpack_require__(58);

var _pwa2 = _interopRequireDefault(_pwa);

var _reset = __webpack_require__(59);

var _reset2 = _interopRequireDefault(_reset);

var _send = __webpack_require__(60);

var _send2 = _interopRequireDefault(_send);

var _spam = __webpack_require__(61);

var _spam2 = _interopRequireDefault(_spam);

var _splash = __webpack_require__(62);

var _splash2 = _interopRequireDefault(_splash);

var _texts = __webpack_require__(63);

var _texts2 = _interopRequireDefault(_texts);

var _bin = __webpack_require__(64);

var _bin2 = _interopRequireDefault(_bin);

var _byte_range = __webpack_require__(65);

var _byte_range2 = _interopRequireDefault(_byte_range);

var _char_range = __webpack_require__(66);

var _char_range2 = _interopRequireDefault(_char_range);

var _random_bytes = __webpack_require__(67);

var _random_bytes2 = _interopRequireDefault(_random_bytes);

var _random_chars = __webpack_require__(68);
...
dwst.functions = new _functions2.default(dwst, [_bin2.default, _byte_range2.default, _char_range2.default, _random_bytes2.default, _random_chars2.default, _text2.default, _time2.default]);
...
var _dwstgg = __webpack_require__(11);
...
var _developing = __webpack_require__(14);

var _developing2 = _interopRequireDefault(_developing);

var _development = __webpack_require__(15);

var _development2 = _interopRequireDefault(_development);

var _firefox = __webpack_require__(16);
...
var _introduction = __webpack_require__(18);
...
var _privacy = __webpack_require__(20);
...
var _simulator = __webpack_require__(22);

var _simulator2 = _interopRequireDefault(_simulator);

var _unprotected = __webpack_require__(23);
  ...
  _createClass(Dwstgg, [{
    ...
    value: function _helpPage(section) {
      ...
      if (section === '#functions') {
        var functions = this._dwst.functions.getNames();
    ...
    value: function _functionHelp(section) {
      ...
      var func = this._dwst.functions.getFunction(funcName);
      if (func === null) {
...
var _section_list = __webpack_require__(4);
...
var _terminal = __webpack_require__(25);
...
var _send_button = __webpack_require__(32);

var _send_button2 = _interopRequireDefault(_send_button);

var _menu_button = __webpack_require__(33);
...
var _log_entry = __webpack_require__(26);

var _log_entry2 = _interopRequireDefault(_log_entry);

var _gfx = __webpack_require__(29);
...
var _direction = __webpack_require__(27);

var _direction2 = _interopRequireDefault(_direction);

var _mlog = __webpack_require__(28);
...
var _pwa = __webpack_require__(44);
...
var Functions = function () {
  function Functions(dwst, functionClasses) {
  ...
  _createClass(Functions, [{
    ...
    value: function getFunction(functionName) {
      var func = this._commands.get(functionName);
...
var Binary = function () {
  ...
  _createClass(Binary, [{
    ...
    value: function _process(instr, params) {
      ...
      var func = this._dwst.functions.getFunction(instr);
      if (func === null) {
    ...
    value: function run(paramString) {
      ...
      var processed = parsed.map(function (particle) {
        ...
        var textOrBinary = _this._process(instruction, args);
        if (textOrBinary.constructor === Uint8Array) {
          return textOrBinary;
        }
        var binary = new TextEncoder().encode(textOrBinary);
        return binary;
      });
  ...
  _createClass(Send, [{
    ...
    value: function run(paramString) {
      ...
      var processed = parsed.map(function (particle) {
        ...
        var text = new TextDecoder('utf-8').decode(textOrBinary, { fatal: true });
        return text;
      });
...
var Bin = function () {
  ...
  _createClass(Bin, [{
    ...
    key: 'usage',
    value: function usage() {
      return ['bin(<variable name>)'];
    }
  }, {
    key: 'examples',
    value: function examples() {
      return ['/s ${bin(foo)}', '/b ${bin(foo)}'];
    }
  }, {
    key: 'type',
    value: function type() {
...
var RandomBytes = function () {
  ...
  _createClass(RandomBytes, [{
    ...
    key: 'examples',
    value: function examples() {
      return ['/s rpc(${randomBytes(5)})', '/b ${randomBytes(16)}'];
    }
  }, {
    key: 'type',
    value: function type() {
